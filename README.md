...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-17 12:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a601390b-3742-4613-8ca5-b0cd13b592ed.git
$ cd a601390b-3742-4613-8ca5-b0cd13b592ed
```
